...
{
    public partial class preguntaOpinion : System.Web.UI.Page
    {
            protected void Page_Load(object sender, EventArgs e)
            {
                GridView1.DataSource = Libreria.consulta("select * from preguntascortas where estado = 'A'");
                GridView1.DataBind();
            ...
            protected void Button2_Click(object sender, EventArgs e)
            {
                ...
                if (Session["modo"] == "i")
                {
                    sql = "INSERT INTO preguntascortas (pregunta,estado) VALUES('" + textPregunta.Text + "','A')";


                }
                else if (Session["modo"] == "m")
                {
                    sql = "UPDATE preguntascortas SET pregunta='" + textPregunta.Text + "' where id=" + txtCodigo.Text;
