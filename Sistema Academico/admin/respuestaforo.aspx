<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="respuestaforo.aspx.cs" Inherits="Sistema_Academico.admin.respuestaforo" %>
...
<asp:Panel ID="Panel1" runat="server" Visible="False">
    <table style="width:100%;">
        ...
        <tr>
            <td>id Pregunta</td>
            <td>
                <asp:TextBox ID="txtIdPregunta" runat="server"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>Respuesta</td>
            <td>
                <asp:TextBox ID="txtRepuesta" runat="server"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
