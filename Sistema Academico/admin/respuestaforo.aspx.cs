...
namespace Sistema_Academico.admin
{
    public partial class respuestaforo : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "UPDATE respuestaforos SET id_usuario='" + txtidUsuario.Text + "',id_foro='" + txtIdPregunta.Text + "',respuesta='" + txtRepuesta.Text + "' where id=" + txtCodigo.Text;


            }
            else
            {
                sql = "UPDATE respuestaforos SET estado='I' where id =" + txtCodigo.Text;
