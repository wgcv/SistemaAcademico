<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="concursos.aspx.cs" Inherits="Sistema_Academico.admin.concursos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False">
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style6">Imagen</td>
