...
namespace Sistema_Academico
{
    public partial class concursos : System.Web.UI.Page
    {
        ...
        {
            //se consulta las concursos
            DataSet ds = Libreria.consulta("select * from concurso where estado ='A' order by id DESC");
            //se inicia la tabla
            lblTabla.Text = "<table style=\"width:95%;border: solid 2px #333;\" >";
            //Pone titulo 
            lblTabla.Text += " <tr ><td style=\"border: solid 2px #696969;    background: #555175;\"><h1 style=\"margin: 1em;\">Concursos</h1></td></tr>";
        ...
        {
            Libreria.ejecuta("INSERT INTO CONTACTOS(nombre, correo, grupo_id) values('" + txtNombre.Text + "', '" + txtCorreo.Text + "',3)");
